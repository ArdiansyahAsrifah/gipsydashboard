          ...
          <header className="topbar">
            ...
            <div className="topbar-right">
              ...
              <div style={{ position: 'relative' }}>
                <div className="avatar-top" onClick={() => setShowUserMenu(u => !u)} title={user.name}>
                ...
                {showUserMenu && (
                    ...
                    <div style={{ padding: '10px 16px 12px', borderBottom: `0.5px solid ${C.border}` }}>
                        <div style={{ fontSize: 13, fontWeight: 600, color: C.text }}>{user.name}</div>
                        <div style={{ fontSize: 11, color: C.text4 }}>{user.role}</div>
                    </div>
                    <div
                        onClick={onLogout}
                        style={{
                        padding: '10px 16px', fontSize: 12, color: '#F87171',
